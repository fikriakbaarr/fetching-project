                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 20%">
                                            <form action="{{ route('cart-delete', $cart->id) }}" method="POST">
                                                @method('DELETE')
                                                @csrf
                                                <button type="submit" class="btn btn-remove-cart"> Remove
                                                </button>
                                            </form>
                                        </td>
                                    </tr>
                ...
                <form action="{{ route('checkout') }}"id="locations" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="addres" aria-describedby="emailHelp"
                                    name="addres" value="Setra Duta Cemara" />
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row" data-aos="fade-up" data-aos-delay="200">
                        ...
                        {{-- <div class="col-4 col-md-2">
                            <div class="product-title">Rp>ongkos kirim ke Jakarta</div>
                        </div> --}}
                        <div class="col-4 col-md-2">
